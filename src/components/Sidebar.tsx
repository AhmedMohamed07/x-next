...
const Sidebar = () => {
  return (
    <div className="hidden sm:inline p-3 space-y-4 h-screen flex-1 ">
      <Link href={'/'}>
      ...
      <button className="hidden xl:inline bg-blue-400 text-white font-bold px-4 py-2 mt-4 hover:bg-blue-600 transition-all duration-200 rounded-full w-40 h-10">
        Sign In
      </button>
    </div>
  );
